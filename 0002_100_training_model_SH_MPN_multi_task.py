...
path_addr = r'G:\MPN\Phase1_module_2\Try_fliter_only_data2048\Scaled_raw'
file_all = []
...
torch.save(model_ss,
           r'G:\MPN\Phase1_module_2\512\SH_MF_PV_ET_100_times.pkl')

his_csv_out = clean_hist(hist_final)
his_csv_out.to_csv(r'G:\MPN\Phase1_module_2\512\SH_MF_PV_ET_100_times.csv')
