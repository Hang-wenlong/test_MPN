...
path_addr = r'D:\论文code\MPN\To_Feng\Scaled_raw_512'
file_all = []
...
ET_file = get_filelist(path=r"D:\论文code\MPN\To_Feng\Scaled_raw",
                        regex_= "ET")
...
torch.save(model_ss,
           r'G:\MPN\Phase1_module_2\512\SH_MF_PV_ET_400_times.pkl')

his_csv_out = clean_hist(hist_final)
his_csv_out.to_csv(r'G:\MPN\Phase1_module_2\512\SH_MF_PV_ET_400_times.csv')
