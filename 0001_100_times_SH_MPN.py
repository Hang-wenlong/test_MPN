...
file_all = []
for root_i ,dirs_i,files_i in os.walk('./Data/Scaled_raw_100'):
    for f_i in files_i:
...
torch.save(model_ss,
           r'/data/MPN/results/SH_MF_PV_ET_100_times.pkl')

his_csv_out = clean_hist(hist_final)
his_csv_out.to_csv(r'/data/MPN/results/SH_MF_PV_ET_100_times.csv')
